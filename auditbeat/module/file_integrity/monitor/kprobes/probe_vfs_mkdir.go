...
func init() {
	registerKProbe[VFSMkdir]("vfs_mkdir",
	...
	registerKRetProbe[KRetProbeGeneric]("vfs_mkdir")
}

type VFSMkdir struct {
...
func (v *VFSMkdir) SetAddressID(id uint32) {
	v.AddressID = id
}

func (v *VFSMkdir) GetProbeEventKey() ProbeEventKey {
...
func (v *VFSMkdir) ShouldIntercept(dirCache dirEntryCache) bool {
...
func (v *VFSMkdir) Emit(dirCache dirEntryCache, emitter Emitter) error {
...
func (v *VFSMkdir) Assume(dirCache dirEntryCache, emitter Emitter) error {
