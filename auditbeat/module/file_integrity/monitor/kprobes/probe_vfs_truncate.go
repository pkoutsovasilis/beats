...
func (v *VFSTruncate) SetAddressID(id uint32) {
	v.AddressID = id
}

func (v *VFSTruncate) GetProbeEventKey() ProbeEventKey {
...
func (v *VFSTruncate) ShouldIntercept(dirCache dirEntryCache) bool {
...
func (v *VFSTruncate) Emit(dirCache dirEntryCache, emitter Emitter) error {
...
func (v *VFSTruncate) Assume(dirCache dirEntryCache, emitter Emitter) error {
